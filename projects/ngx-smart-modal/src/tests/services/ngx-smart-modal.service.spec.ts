...
import { inject, TestBed, waitForAsync, tick, fakeAsync } from '@angular/core/testing';
...
describe('NgxSmartModalService', () => {
  ...
  it('should add modal (force)', inject([NgxSmartModalService, NgxSmartModalStackService],
    (service: NgxSmartModalService, stackService: NgxSmartModalStackService) => {
      ...
      expect(stackService.addModal).toHaveBeenCalledWith({ fake: 'obj' } as any, true);
    }));

  it('should get modal data', inject([NgxSmartModalService], (service: NgxSmartModalService) => {
    spyOn(service, 'get').and.returnValue({ getData: (() => 'test data') } as any);
  ...
  it('should get modal data (invalid id)', inject([NgxSmartModalService], (service: NgxSmartModalService) => {
    spyOn(service, 'get').and.returnValue(undefined as any);
  ...
  it('should set modal data (invalid id)', inject([NgxSmartModalService], (service: NgxSmartModalService) => {
    spyOn(service, 'get').and.returnValue(false as any);
  ...
  it('should get (modal)', inject([NgxSmartModalService], (service: NgxSmartModalService) => {
    spyOn(service, 'getModal').and.returnValue('fake' as any);
  ...
  it('should open', inject([NgxSmartModalService], (service: NgxSmartModalService) => {
    spyOn(service, 'get').and.returnValue('fake' as any);
    spyOn(service as any, '_openModal');
  ...
  it('should get modal stack', inject([NgxSmartModalService, NgxSmartModalStackService],
    (service: NgxSmartModalService, stackService: NgxSmartModalStackService) => {
      spyOn(stackService, 'getModalStack').and.returnValue('fake' as any);
  ...
  it('should get top opened modal', inject([NgxSmartModalService, NgxSmartModalStackService],
    (service: NgxSmartModalService, stackService: NgxSmartModalStackService) => {
      spyOn(stackService, 'getTopOpenedModal').and.returnValue('fake' as any);
  ...
  it('should close latest modal', inject([NgxSmartModalService], (service: NgxSmartModalService) => {
    spyOn(service, 'getOpenedModals').and.returnValue(['test'] as any);
    spyOn(service, 'getTopOpenedModal').and.returnValue({ close: () => 'test_close' } as any);
  ...
  it('should destroy modal', inject([NgxSmartModalService, NgxSmartModalStackService], (service: NgxSmartModalService, stackService: NgxSmartModalStackService) => {
    ...
    spyOn(stackService, "removeModal").and.returnValue({ id: fakeModalId, modal: fakeModal } as any);
